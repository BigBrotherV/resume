$(document).ready(function() {
  ...
  $('.mask').animate({height: '100%'}, 700, function() {
    $('.mask').fadeOut(300);
  });
  ...
  $("#fullpage").fullpage({
    ...
    afterLoad: function(anchorLink, index) {
      ...
      if (index == 2) {
        ...
        $(".about-me").animate({width: "80%"}, 500, function() {
          var en = $('.en').html();
          if (en == 'EN') {
          ...
          $('.info-l').animate({height: "65%"}, 500, function() {
            $('.info-r').animate({width: "48%"}, 500, function() {
        ...
        $(".about-me").animate({width: "0"}, 10, function() {
          $('.info-l').animate({height: "0"}, 10, function() {
            $('.info-r').animate({width: "0"}, 10);
          });
        });
      }

      if (index == 5) {
        $('.slide-r').animate({width: "35%",padding: "20px"}, 500, function() {
    ...
    afterSlideLoad: function(anchorLink, index, slideAnchor, slideIndex) {
      if(index == 5 && slideIndex == 'firstSlide'){
        console.log('11111');
      }
    }
    ...
    $('.zh').on('click', function(e) {
      e.preventDefault();
      $('.lan-move').animate({left:"0"}, 300, chinese());
    });

    $('.en').on('click', function(e) {
      e.preventDefault();
      $('.lan-move').animate({left:"30px"}, 300, english());
    });
    ...
    function english () {
      ...
      $('.fifth-page .title').html('Exhibition of works');
